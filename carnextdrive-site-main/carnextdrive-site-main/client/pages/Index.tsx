...
export default function Index() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-cover bg-center" style={{ backgroundImage: "url('/Cars/Ecar.JPG')" }}>
        <div className="grid grid-cols-1 gap-0 min-h-[500px]">
          {/* Left side - Text content */}
          <div className="flex flex-col justify-center px-6 sm:px-12 py-12 lg:py-0">
      ...
      <section id="how-it-works" className="py-7 bg-white">
      ...
      <footer className="bg-foreground text-white py-12">
        <div className="max-w-7xl mx-auto px-6 sm:px-12">
          ...
          <div className="border-t border-white/20 pt-8 text-center text-white/70 text-sm">
            <p>&copy; 2026 CarNextDrive. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
